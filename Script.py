...
<b>എന്റെ പണി എന്ന് പറഞ്ഞാൽ പുതിയതായിട്ട് വരുന്ന തീയറ്റർ പ്രിന്റ് [PreDVD] മൂവീസിന്റെ  ലിങ്ക് ഇടുക...!</b>
...
Tʜɪs Bᴏᴛ ʜᴀs Lᴀᴛᴇsᴛ ᴀɴᴅ Aᴅᴠᴀɴᴄᴇᴅ Fᴇᴀᴛᴜʀᴇs
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/pcmoviegroup)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/pcmoviegroup>Movie Group</a></b> 
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
Sᴏʀʀʏ Bʀᴏ Yᴏᴜʀ Nᴏᴛ Jᴏɪɴᴇᴅ Mʏ Cʜᴀɴɴᴇʟ Sᴏ Pʟᴇᴀsᴇ Cʟɪᴄᴋ Jᴏɪɴ Bᴜᴛᴛᴏɴ Tᴏ Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ Aɴᴅ Tʀʏ Aɢᴀɪɴ"""
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: உங்கள் இணையதளம் மற்றும் API ஐச் சேர்க்கவும்
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: మీ వెబ్‌సైట్ మరియు APIని జోడించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: अपनी वेबसाइट और एपीआई जोड़ें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: നിങ്ങളുടെ വെബ്‌സൈറ്റും API-യും ചേർക്കുക
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારી વેબસાઇટ અને API ઉમેરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ನಿಮ್ಮ ವೆಬ್‌ಸೈಟ್ ಮತ್ತು API ಸೇರಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার ওয়েবসাইট এবং API যোগ করুন
